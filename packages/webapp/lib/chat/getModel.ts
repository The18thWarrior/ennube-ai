...
const getModel = () => {
  ...
  return openrouter(process.env.OPENROUTER_MODEL || 'deepseek/deepseek-chat-v3.1'); // openai/gpt-oss-120b deepseek/deepseek-chat-v3.1 deepseek/deepseek-chat-v3-0324 | google/gemini-2.0-flash-001
