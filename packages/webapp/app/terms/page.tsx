        ...
        <div className="mt-10">
          <div className="prose prose-lg prose-indigo max-w-none">
            <section className="mb-8">
              ...
              <p>
                These Terms of Service ("Terms") govern your access to and use of the Ennube.ai website and services
            ...
            <section className="mb-8">
              ...
              <p>
                Ennube.ai provides AI agents designed to automate repetitive tasks, analyze customer data, and enhance
                CRM workflows. Our Services include access to our website, API, and related tools.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                ...
                according to the pricing and terms presented to you at the time of purchase.
              </p>
              <p>
                Unless otherwise stated, subscriptions will automatically renew for additional periods equal to the
                expiring subscription term. You may cancel auto-renewal at any time through your account settings.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                By uploading User Content, you grant Ennube.ai a worldwide, royalty-free license to use, host, store,
                reproduce, modify, create derivative works, communicate, publish, publicly perform, publicly display,
                and distribute such User Content for the limited purpose of providing the Services.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-5 mt-2">
                ...
                <li>Attempt to bypass or break any security mechanism on the Services</li>
                <li>
                  Post or transmit any content that is fraudulent, false, misleading, deceptive, or invasive of
                  another's privacy
                </li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                The Services and their original content, features, and functionality are owned by Ennube Inc. and are
            ...
            <section className="mb-8">
              ...
              <p>
                IN NO EVENT SHALL ENNUBE INC. BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR
                PUNITIVE DAMAGES, INCLUDING LOSS OF PROFITS, DATA, OR BUSINESS OPPORTUNITIES, WHETHER BASED ON CONTRACT,
                TORT, NEGLIGENCE, STRICT LIABILITY, OR ANY OTHER LEGAL THEORY.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                We reserve the right to modify these Terms at any time. If we make material changes, we will provide
                notice through our Services or by other means.
              </p>
              <p>
                Your continued use of the Services after such notice constitutes your acceptance of the modified Terms.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p>
                <a href="mailto:legal@ennube.ai" className="text-indigo-600 hover:text-indigo-500">
                  legal@ennube.ai
                </a>
              </p>
            </section>
