...
import { AnomalyStatus, AnomalyColor } from '../types';
 ...
 */
export function detectAnomalies(group, threshold = 0.8) {
    ...
    keys.forEach(key => {
        ...
        const anomalyColor = AnomalyColor[status];
