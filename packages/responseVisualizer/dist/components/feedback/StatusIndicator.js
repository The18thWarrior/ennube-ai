...
export const StatusIndicator = ({ status, text, className }) => {
    const statusClasses = {
    ...
    return (_jsx("div", { className: clsx('status-indicator px-3 py-2 rounded border', statusClasses[status], className), children: text || status }));
};
