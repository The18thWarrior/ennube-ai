 ...
 */
export function getAnimationClasses(animation) {
 ...
 */
export function createTransition(animation) {
    if (!animation || animation.type === 'none') {
        return {};
    }
 ...
 */
export function getLoadingAnimationClasses(type = 'spinner') {
    switch (type) {
        case 'spinner':
            return 'animate-spin';
        case 'skeleton':
 ...
 */
export function getStaggeredDelay(index, baseDelay = 50) {
 ...
 */
export function getHoverAnimationClasses(type = 'lift') {
    switch (type) {
        case 'lift':
 ...
 */
export function getFocusAnimationClasses() {
