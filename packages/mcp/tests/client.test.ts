...
jest.mock('@modelcontextprotocol/sdk/client/index.js', () => ({
  Client: jest.fn().mockImplementation(() => ({
    ...
    callTool: jest.fn().mockImplementation((request: any) => {
    ...
    readResource: jest.fn().mockImplementation((request: any) => {
...
describe('MCPClient', () => {
  ...
  describe('Transport Connections', () => {
    ...
    test('should_handle_connection_errors', async () => {
      ...
      await expect(client.connect(invalidTransport as any)).rejects.toThrow();
